...
final class MessageGenerator {
   ...
   public static byte[] generateByteArray(int bytesLength) {
    ...
    */
   public static byte[] generateExpectedDataSectionBytes(final byte[] payloadBytes) {
      ...
      assert dataBytesLength == buffer.position() : "Unexpected buffer position";
